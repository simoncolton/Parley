...
class MidiUtils:
    ...
    def get_midi_file(composition, performance_spec, soundfont_filepath):
        ...
        for track_num in track_nums:
            MidiUtils.add_track(track_num, composition, midi_file, soundfont_filepath)
        return midi_file

    def add_track(track_num, composition, midi_file, soundfont_filepath):
